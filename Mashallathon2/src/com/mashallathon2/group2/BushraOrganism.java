package com.group2;
    ...
    public class BushraOrganism  extends Organism implements Living {
    
    public int Age;
    public String Country;
    public String City;

    public BushraOrganism(String name, int health, int energy, String Country, String City, int Age) {
