...
public class AljawharahOrganism  extends Organism implements Living{

    public int Age;
    public String Country;
    public String City;

    public AljawharahOrganism(String name, int health, int energy, String Country, String City, int Age) {
